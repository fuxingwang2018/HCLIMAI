...
if [[ "$EXP" == "FPS12" ]]; then
    ...
    FIRST_YEAR=1999
    LAST_YEAR=2009 #2014 available but 2009 to consistent with FPS3
    lonmin='4.5'
    lonmax='17'
    latmin='42.75'
    latmax='48.5'
    VAR_LIST=('tas_fp' )
    #VAR_LIST=('cr_fp' 'csn_fp' 'sr_fp' 'ssn_fp' )  #Precipitation
...
if [[ "$EXP" == "FPS3" ]]; then
    ...
    ncrename -O -v prrain,pr $outdir/$outfile_pr_cmorized $outdir/$outfile_pr_cmorized

elif [[ "$EXP" == "FPS12" ]]; then
    outfile_cr='cr_fp'_${experiment_cmorized}_${FIRST_YEAR}${FIRST_MONTH}_${LAST_YEAR}${LAST_MONTH}'.nc'
    outfile_csn='csn_fp'_${experiment_cmorized}_${FIRST_YEAR}${FIRST_MONTH}_${LAST_YEAR}${LAST_MONTH}'.nc'
    outfile_sr='sr_fp'_${experiment_cmorized}_${FIRST_YEAR}${FIRST_MONTH}_${LAST_YEAR}${LAST_MONTH}'.nc'
    outfile_ssn='ssn_fp'_${experiment_cmorized}_${FIRST_YEAR}${FIRST_MONTH}_${LAST_YEAR}${LAST_MONTH}'.nc'
    outfile_pr='pr_fp'_${experiment_cmorized}_${FIRST_YEAR}${FIRST_MONTH}_${LAST_YEAR}${LAST_MONTH}'.nc'
    outfile_pr_cmorized='pr'_${experiment_cmorized}_${FIRST_YEAR}${FIRST_MONTH}_${LAST_YEAR}${LAST_MONTH}'.nc'
    cdo enssum $outdir/$outfile_cr $outdir/$outfile_csn $outdir/$outfile_sr $outdir/$outfile_ssn $outdir/$outfile_pr
    rm $outdir/$outfile_cr $outdir/$outfile_csn $outdir/$outfile_sr $outdir/$outfile_ssn 
    mv $outdir/$outfile_pr  $outdir/$outfile_pr_cmorized
    ncrename -O -v cr,pr $outdir/$outfile_pr_cmorized $outdir/$outfile_pr_cmorized
fi
